# Assignment 0: Milestones in the History of Computing (due 06/11/21)
...
8. To submit the assignment, you should generate a PDF containing each group members' name and upload it to Gradescope by the due date (06/11/21).
